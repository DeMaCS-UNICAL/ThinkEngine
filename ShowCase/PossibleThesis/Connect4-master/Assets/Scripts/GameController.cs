...
namespace ConnectFour
{
    public class GameController : MonoBehaviour
    {
        ...
        public GameObject SpawnPiece()
        {
            ...
            Debug.Log("Posizione del mouse " + spawnPos);
        ...
        void Update()
        {
            comp = gameObject.GetComponents(typeof(IMonoBehaviourSensor));
            Debug.Log("Comp num = " + comp.Length);
            if (isLoading)
                return;
            ...
            if (field.IsPlayersTurn)
            {
                ...
                else
                {
                    ...
                    Vector3 pos1 = new Vector3(K, 0, 0);
                    gameObjectTurn.transform.position = new Vector3(
                      Mathf.Clamp(pos1.x, 0, numColumns - 1),
        ...
        IEnumerator dropPiece(GameObject gObject)
        {
            ...
            aiplayer.GetComponent<player>().mioTurno = true;
            yield return 0;
        }
